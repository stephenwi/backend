...
class ViteAssetExtension extends AbstractExtension
{
    ...
    public function __construct(private bool $isDev, private string $manifest, private CacheItemPoolInterface $cache)
    {
    }
    ...
    public function assetProd(string $entry): string {
        ...
        if ($this->manifestData === null) {
         ...
         $html = <<<HTML
        <script type="module" src="/assets:5173/assets/{$file}" defer></script>
HTML;
...
HTML;
    ...
    public function assetDev(string $entry, array $deps): string {
        $html = <<<HTML
        <script type="module" src="http://localhost/assets:5173/assets/@vite/client"></script>
HTML;
